  ...
  return (
    <div>
      <Modal
        ...
        style={customStyle}
      >
        <div style={{ textAlign: "center", height:'30vh', marginTop: 30 }}>
      ...
      <div style={{ display: "flex", justifyContent: "between" }} className="back-link">
        <FontAwesomeIcon
          ...
          onClick={() => navigate(-1)}
        />
        <h4 style={{ color: "white"}} className="wallet-addr-txt" >
          Wallet Address:

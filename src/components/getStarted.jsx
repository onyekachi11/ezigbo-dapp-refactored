...
const Greetings = ({account,openMenu}) => {
  return (
    <>
    <MainBar openMenu={openMenu} pageTitle="Welcome to manufacturer dashboard" account={account}>
...
const GetStarted = ({ contract, account, isMenuOpen, openMenu,closeMenu}) => {
    ...
    return (
      <div>
        <div style={{ textAlign: "center", marginTop: 40 }}>
          ...
          <br />
          <a href="https://www.google.com">Proceed to the Home Page</a>
        </div>
      </div>
    );
  }
